            ...
            <div class="row">
              <div class="col-lg-12">
                <form id="login-form" action="summa.php" method="post" role="form" style="display: block;">
				  ...
				  <input type="text" name="email_id" id="username" tabindex="1" class="form-control" placeholder="Email id" value="">
                  <?php 
                ...
                <form id="register-form" action="register_process.php" method="post" role="form" style="display: none;">
                  ...
                  <div class="form-group">
                    <input  type ="text" pattern="[789][0-9]{9}" name="phone" id="phone"  class="form-control" placeholder="Phone Number" value="">
                  </div>
				  <div class="form-group">
